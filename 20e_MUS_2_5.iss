Sub Main
	Call MUSExtraction()	'Massa=2 + 5.IMD
End Sub
...
Function MUSExtraction
	...
	Set db = Client.OpenDatabase("Massa=2 + 5.IMD")
	...
	task.SampleInterval = 180000.00
	task.RandomValue = 1913
	task.FieldToSample = "BETRG"
	dbName = "MUS massa 2 object 5.IMD"
