Sub Main
	Call MUSExtraction()	'Massa=2 + 3.IMD
End Sub
...
Function MUSExtraction
	...
	Set db = Client.OpenDatabase("Massa=2 + 3.IMD")
	...
	task.SampleInterval = 200000.00
	task.RandomValue = 1332
	task.FieldToSample = "BETRG"
	dbName = "MUS massa 2 object 3.IMD"
