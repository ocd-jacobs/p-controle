Sub Main
	Call MUSExtraction()	'Massa=1 + 4.IMD
End Sub
...
Function MUSExtraction
	...
	Set db = Client.OpenDatabase("Massa=1 + 4.IMD")
	...
	task.SampleInterval = 230000.00
	task.RandomValue = 5437
	task.FieldToSample = "BETRG"
	dbName = "MUS massa 1 object 4.IMD"
