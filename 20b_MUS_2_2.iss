Sub Main
	Call MUSExtraction()	'Massa=2 + 2.IMD
End Sub
...
Function MUSExtraction
	...
	Set db = Client.OpenDatabase("Massa=2 + 2.IMD")
	...
	task.SampleInterval = 560000.00
	task.RandomValue = 571
	task.FieldToSample = "BETRG"
	dbName = "MUS massa 2 object 2.IMD"
