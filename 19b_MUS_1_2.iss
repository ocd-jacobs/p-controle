Sub Main
	Call MUSExtraction()	'Massa=1 + 2.IMD
End Sub
...
Function MUSExtraction
	...
	Set db = Client.OpenDatabase("Massa=1 + 2.IMD")
	...
	task.SampleInterval = 1630000.00
	task.RandomValue = 2671
	task.FieldToSample = "BETRG"
	dbName = "MUS massa 1 object 2.IMD"
